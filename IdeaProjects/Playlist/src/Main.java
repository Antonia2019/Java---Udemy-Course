...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        albums.get(0).addPlaylist("My Friends", playList); //already exist
        albums.get(0).addPlaylist("Aeroplane", playList);
        albums.get(0).addPlaylist("Dark Road", playList); //does not exist
        albums.get(0).addPlaylist(9, playList);
        albums.get(1).addPlaylist(7, playList);
        albums.get(1).addPlaylist(3, playList);
        albums.get(1).addPlaylist(1, playList);
        albums.get(1).addPlaylist(17, playList); //does not have a track no
