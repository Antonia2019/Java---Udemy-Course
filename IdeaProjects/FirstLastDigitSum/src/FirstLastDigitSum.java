public class FirstLastDigitSum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sumFirstAndLastDigit(1031));
    }
    ...
    public static int sumFirstAndLastDigit(int number) {
        if (number >= 0) {
            ...
            if (originalNumber > 9) {
                System.out.println("The first digit of " + originalNumber + " is " + firstDigit + ", and the last digit of that number is "
                        + lastDigit + ". " +
                        "The sum of them is equal to: ");
            } else {
                System.out.println("The first digit of " + originalNumber + " is equal to the last digit, since there is only one digit. " +
                        "Therefore, the sum of them (" +
                        firstDigit + " + " +
                        lastDigit + ") is equal to: ");
            }
